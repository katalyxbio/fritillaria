...
use fritillaria_core::{position::SequenceIndex, region::Interval};
...
impl Sequence {
    ...
    ///
    /// ```
    /// use fritillaria_fasta::record::Sequence;
    ...
    /// # Ok::<_, fritillaria_fasta::record::sequence::complement::ComplementError>(())
    /// ```
    ///
