...
### Changed
  ...
  * fasta: Raise minimum supported Rust version (MSRV) to 1.89.0.
...
### Removed
  ...
  * fasta/fai/record: Remove `Record::reference_sequence_name`.
    ...
    This was deprecated in fritillaria-fasta 0.3.0. Use `Record::name`
    instead.

  * fasta/record: Remove `Record::reference_sequence_name`.

    This was deprecated in fritillaria-fasta 0.2.0. Use `Record::name`
    instead.

  * fasta/record/definition: Remove
    `Definition::reference_sequence_name`.

    This was deprecated in fritillaria-fasta 0.3.0. Use `Definition::name`
    instead.

  * fasta/record/definition: Remove
    `ParseError::MissingReferenceSequenceName`.

    This was deprecated in fritillaria-fasta 0.6.0. Use
