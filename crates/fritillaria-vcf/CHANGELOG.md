...
### Changed
  ...
  * vcf: Raise minimum supported Rust version (MSRV) to 1.89.0.
...
### Fixed
  ...
  * vcf: Enable `fritillaria-csi/async` with `async` feature.
...
### Changed
  ...
  * vcf: Raise minimum supported Rust version (MSRV) to 1.88.0.
...
### Changed
  ...
  * vcf: Raise minimum supported Rust version (MSRV) to 1.81.0.
...
### Added
  ...
  * vcf/header: Add string maps (`StringMaps`).
    ...
    This is moved from fritillaria-bcf.
...
### Removed
  ...
  * vcf/header: Remove `Records`.
    ...
    This was deprecated in fritillaria-vcf 0.18.0. Use `OtherRecords`
    instead.

  * vcf/header: Remove `Header::records` and `Header::records_mut`.

    These were deprecated in fritillaria-vcf 0.18.0. Use
...
### Changed
  ...
  * vcf/header: VCF header records parsed from structured lines are now map
    values (`fritillaria_vcf::header::record::value::Map`).
...
### Deprecated
  ...
  * vcf/record: Deprecated `genotype` and `Genotype` public exports.
    ...
    Use `fritillaria_vcf::record::genotypes::{genotype, Genotype}` instead.
