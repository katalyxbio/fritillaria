...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_vcf::{self as vcf, variant::record_buf::Ids};
    ///
    ...
    ///
    /// ```
    /// use fritillaria_vcf::{self as vcf, variant::record_buf::AlternateBases};
    ///
    ...
    ///
    /// ```
    /// use fritillaria_vcf::{self as vcf, variant::record_buf::Filters};
    ///
    /// let record = vcf::variant::RecordBuf::builder()
...
mod tests {
    ...
    fn test_default() {
        ...
        assert_eq!(record.reference_bases, "N");
