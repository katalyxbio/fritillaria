...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_vcf::io::{reader::Builder, CompressionMethod};
    ...
    ///
    /// ```no_run
    /// use fritillaria_vcf::io::reader::Builder;
        ...
        R: Read + 'r,
    {
        let inner: Box<dyn BufRead> = match self.compression_method {
            Some(CompressionMethod::Bgzf) => Box::new(bgzf::io::Reader::new(reader)),
