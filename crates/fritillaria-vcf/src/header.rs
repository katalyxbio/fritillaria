...
impl Header {
    ...
    ///
    /// ```
    /// use fritillaria_vcf::{self as vcf, header::FileFormat};
    ///
    ...
    ///
    /// ```
    /// use fritillaria_vcf::{self as vcf, header::record::value::{map::Filter, Map}};
    ///
    ...
    ///
    /// ```
    /// use fritillaria_vcf::{self as vcf, header::record::value::{map::Contig, Map}};
    ///
    ...
    ///
    /// ```
    /// use fritillaria_vcf::{self as vcf, header::record::Value};
    ///
    /// let header = vcf::Header::builder()
