...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_gff::{self as gff, feature::record::Strand};
    ///
    /// let record = gff::feature::RecordBuf::builder()
    ...
    ///
    /// ```
    /// use fritillaria_gff::{self as gff, feature::record::Phase};
...
mod tests {
    ...
    #[test]
    fn test_build() -> Result<(), fritillaria_core::position::TryFromIntError> {
