...
### Changed
  ...
  * gff: Raise minimum supported Rust version (MSRV) to 1.89.0.
...
### Changed
  ...
  * gff: Raise minimum supported Rust version (MSRV) to 1.88.0.
...
### Removed
  ...
  * gff/lazy/record: Remove `Position` and `Strand` wrappers.
    ...
    These fields are now parsed as `fritillaria_core::Position` and
