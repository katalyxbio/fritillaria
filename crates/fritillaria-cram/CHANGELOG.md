...
### Changed
  ...
  * cram: Update to lzma-rust2 0.19.0.
...
### Changed
  ...
  * cram/record: Change `cram::Record` to be read-only.
    ...
    fritillaria-cram no longer has a public, mutable CRAM record. Use a more
...
### Removed
  ...
  * cram/record/builder: Remove deprecated methods.
    ...
    These were deprecated in fritillaria-cram 0.47.0. Use the following instead:
...
### Removed
  ...
  * cram/record/feature/code: Remove `TryFrom<char>` and `TryFromCharError`.
    ...
    These were deprecated in fritillaria-cram 0.13.0. Use `TryFrom<u8>` and
    `TryFromByteError`, respectively, instead.

  * cram/record/feature/code: Remove `From<Code>` for `char`.

    This was deprecated in fritillaria-cram 0.13.0. Convert to a `u8`
    instead.

  * cram/record/resolve: Remove `resolve_features`.

    This was deprecated in fritillaria-cram 0.16.0. Use
