...
### Changed
  ...
  * bed: Raise minimum supported Rust version (MSRV) to 1.89.0.
...
### Changed
  ...
  * bed: Raise minimum supported Rust version (MSRV) to 1.88.0.
...
### Added
  ...
  * bed/feature: Add `Record` trait to represent an opaque feature record.
    ...
    fritillaria-bed now only supports BED3+, BED4+, BED5+, and BED6+. Records with
