    ...
    I: super::Inner,
{
    ...
    /// ```
    /// use bstr::BString;
    /// use fritillaria_sam::header::record::value::{map::{Header, Tag}, Map};
    ///
    ...
    /// # Ok::<_, fritillaria_sam::header::record::value::map::builder::BuildError>(())
    /// ```
    ...
    ///
    /// ```
    /// use fritillaria_sam::header::record::value::{map::Header, Map};
