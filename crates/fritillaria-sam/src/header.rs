...
impl Header {
    ...
    ///
    /// ```
    /// use fritillaria_sam::{self as sam, header::record::value::{map, Map}};
    ///
    ...
    ///
    /// ```
    /// use fritillaria_sam::{self as sam, header::record::value::{map::Program, Map}};
    ///
    /// let program = Map::<Program>::default();
    /// let header = sam::Header::builder().add_program("fritillaria-sam", program).build();
    ///
    /// let programs = header.programs();
    /// assert_eq!(programs.as_ref().len(), 1);
    /// assert!(programs.as_ref().contains_key(&b"fritillaria-sam"[..]));
    /// ```
    ...
    ///     .programs_mut()
    ///     .as_mut()
    ///     .insert(String::from("fritillaria-sam").into(), program);
    ///
    /// let programs = header.programs();
    /// assert_eq!(programs.as_ref().len(), 1);
    /// assert!(programs.as_ref().contains_key(&b"fritillaria-sam"[..]));
    ...
    /// use bstr::BString;
    /// use fritillaria_sam as sam;
    /// let header = sam::Header::builder().add_comment("fritillaria-sam").build();
    /// let comments = header.comments();
    /// assert_eq!(header.comments(), [BString::from("fritillaria-sam")]);
    /// ```
    ...
    /// use fritillaria_sam as sam;
    /// let mut header = sam::Header::default();
    /// header.comments_mut().push(BString::from("fritillaria-sam"));
    /// assert_eq!(header.comments(), [BString::from("fritillaria-sam")]);
    /// ```
    ...
    /// use fritillaria_sam as sam;
    /// let mut header = sam::Header::default();
    /// header.add_comment("fritillaria-sam");
    /// assert_eq!(header.comments(), [BString::from("fritillaria-sam")]);
    /// ```
