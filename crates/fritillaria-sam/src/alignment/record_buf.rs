...
impl RecordBuf {
    ...
    ///
    /// ```
    /// use fritillaria_sam::{self as sam, alignment::record::Flags};
    /// let record = sam::alignment::RecordBuf::default();
    ...
    ///
    /// ```
    /// use fritillaria_sam::{self as sam, alignment::record::MappingQuality};
    /// let mut record = sam::alignment::RecordBuf::default();
    ...
    ///
    /// ```
    /// use fritillaria_sam::{self as sam, alignment::record_buf::Sequence};
    ///
    ...
    ///
    /// ```
    /// use fritillaria_sam::{self as sam, alignment::record_buf::QualityScores};
    ///
    ...
    /// # Ok::<_, fritillaria_core::position::TryFromIntError>(())
    /// ```
