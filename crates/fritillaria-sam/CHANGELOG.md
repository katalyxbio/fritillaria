...
### Changed
  ...
  * sam: Raise minimum supported Rust version (MSRV) to 1.88.0.
...
### Changed
  ...
  * sam: Raise minimum supported Rust version (MSRV) to 1.85.0.
...
### Changed
  ...
  * sam: Raise minimum supported Rust version (MSRV) to 1.81.0.
...
### Removed
  ...
  * sam/alignment: Removed `iter`.
    ...
    This is moved to fritillaria-util.
...
### Removed
  ...
  * sam/header/builder: Remove `Header::new`.
    ...
    This was deprecated in fritillaria-sam 0.12.0. Use `Header::builder`
    instead.
  ...
  * sam/header/record/value/map/version: Remove
    ...
    These were deprecated in fritillaria-sam 0.12.0. Use
    `ParseError::Invalid` instead.

  * sam/record/cigar: Remove `Cigar::reference_len` and `Cigar::read_len`.

    These were deprecated in fritillaria-sam 0.16.0. Use
  ...
  * sam/record/flags: Remove "pair" aliases in favor of "segmented".
    ...
    These were deprecated in fritillaria-sam 0.9.0. Use the following
    instead:
...
### Changed
  ...
  * sam/header: SAM header records parsed from maps are now map values
    (`fritillaria_sam::header::record::value::Map`).
...
### Removed
  ...
  * sam/record: Remove `Position`.
    ...
    Use `fritillaria_core::Position` instead.
