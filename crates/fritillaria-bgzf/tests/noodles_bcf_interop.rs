...
//!
//! `tests/noodles_interop.rs` shows noodles' BAM reader sitting on top of this
//! one. The design note in CLAUDE.md makes a stronger claim from that: because
//! every noodles format reader is generic over `noodles_bgzf::io::BufRead`, a
//! *second* BGZF-contained format should need no new code from us at all.
//!
...
//! this file touches BCF: it opens a bcftools-written file through
//! [`BgzfReader`], hands it to noodles, and reads variants out.
//!
