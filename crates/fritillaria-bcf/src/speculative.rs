...
//!
//! `fritillaria_bam::blocked` escapes it by leaning on htslib: `bgzf_flush_try`
...
use crate::record::{Record, looks_like_a_record, scan_records};
...
mod tests {
    use super::*;
    use crate::record::SITE_CORE_SIZE;
