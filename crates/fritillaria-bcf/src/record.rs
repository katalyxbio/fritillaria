...
use crate::typed::{self, Float, Int, Kind, Typed};
...
/// `fritillaria_bam::blocked` applies to its per-block guesses.
#[must_use]
...
impl<'a> Record<'a> {
    ...
    /// Contig index — an offset into [`crate::Dictionary::contigs`], not a name.
    #[must_use]
