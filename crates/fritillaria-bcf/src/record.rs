...
impl Record {
    ...
    /// ```
    /// use fritillaria_bcf as bcf;
    /// use fritillaria_vcf::variant::record::Ids;
    /// let record = bcf::Record::default();
    ...
    /// ```
    /// use fritillaria_bcf as bcf;
    /// use fritillaria_vcf::variant::record::AlternateBases;
    /// let record = bcf::Record::default();
    ...
    /// ```
    /// use fritillaria_bcf as bcf;
    /// use fritillaria_vcf::variant::record::Filters;
    /// let record = bcf::Record::default();
    ...
    /// ```
    /// use fritillaria_bcf as bcf;
    /// use fritillaria_vcf::variant::record::Info;
    /// let record = bcf::Record::default();
    ...
    /// ```
    /// use fritillaria_bcf as bcf;
    /// use fritillaria_vcf::variant::record::Samples;
    /// let record = bcf::Record::default();
