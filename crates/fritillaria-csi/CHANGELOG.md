...
### Changed
  ...
  * csi: Raise minimum supported Rust version (MSRV) to 1.89.0.
...
### Changed
  ...
  * csi: Raise minimum supported Rust version (MSRV) to 1.88.0.
...
### Added
  ...
  * csi/async/io: Add async query reader (`csi::r#async::io::Query`).
...
### Added
  ...
  * csi/index: Add `Header`.
    ...
    `fritillaria_tabix::index::Header`.
...
### Changed
  ...
  * csi/index: Replace `aux` with an optional tabix header
    ...
    It isn't clear what `aux` is supposed to be used for, so fritillaria-csi
...
### Removed
  ...
  * csi: Remove `BinningIndexReferenceSequence`.
    ...
    This was deprecated in fritillaria-csi 0.4.0. Use
    `fritillaria_csi::binning_index::ReferenceSequenceExt` instead.

  * csi/index: Remove `Index::unmapped_read_count`.

    This was deprecated in fritillaria-csi 0.2.0. Use
...
### Added
  ...
  * csi/binning_index: Added chunk merging functions for chunk list reduction
    (`fritillaria_csi::binning_index::{merge_chunks, optimize_chunks}`).
