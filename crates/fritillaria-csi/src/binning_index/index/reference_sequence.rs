...
use fritillaria_core::{Position, region::Interval};
    ...
    I: Index,
{
    ...
    ///
    /// ```
    /// use fritillaria_csi::binning_index::index::ReferenceSequence;
    ...
    /// use fritillaria_bgzf as bgzf;
    /// use fritillaria_core::Position;
    /// use fritillaria_csi::binning_index::index::{
...
mod tests {
    ...
    #[test]
    fn test_reg2bins() -> Result<(), fritillaria_core::position::TryFromIntError> {
        // +------------------------------------------------------------------------------------...
        // | 0                                                                                  ...
        // | 0-1023                                                                             ...
        // +-------------------------------------------------------------------------+----------...
