...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_csi::binning_index::index::header::Builder;
    ...
    ///
    /// ```
    /// use fritillaria_csi::binning_index::index::{header::Format, Header};
    ...
    ///
    /// ```
    /// use fritillaria_csi::binning_index::index::{header::ReferenceSequenceNames, Header};
    ///
