    ...
    I: reference_sequence::Index,
{
    ...
    ///
    /// ```
    /// use fritillaria_csi::{self as csi, BinningIndex};
    ...
    ///
    /// ```
    /// use fritillaria_csi::{self as csi, binning_index::index::Header, BinningIndex};
    ...
    ///
    /// ```
    /// use fritillaria_csi::{self as csi, binning_index::index::ReferenceSequence};
    ///
