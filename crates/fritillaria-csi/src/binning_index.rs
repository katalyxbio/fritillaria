...
/// ```
/// use fritillaria_bgzf as bgzf;
/// use fritillaria_csi::binning_index::{index::reference_sequence::bin::Chunk, merge_chunks};
///
/// let chunks = [
...
/// ```
/// use fritillaria_bgzf as bgzf;
/// use fritillaria_csi::binning_index::{index::reference_sequence::bin::Chunk, optimize_chunks};
///
/// let chunks = [
///     Chunk::new(bgzf::VirtualPosition::from(2), bgzf::VirtualPosition::from(3)),
///     Chunk::new(bgzf::VirtualPosition::from(5), bgzf::VirtualPosition::from(8)),
