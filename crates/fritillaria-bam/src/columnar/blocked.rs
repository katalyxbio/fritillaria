...
use crate::columnar::record::RECORD_CORE_SIZE;
...
///
/// Equivalent to [`scan_records`](crate::columnar::scan_records) in output; see the module
...
mod tests {
    use super::*;
    use crate::columnar::record::scan_records;
