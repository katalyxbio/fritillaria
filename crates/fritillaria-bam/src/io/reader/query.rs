...
use fritillaria_csi::{self as csi, binning_index::index::reference_sequence::bin::Chunk};
use fritillaria_sam::alignment::Record as _;
...
mod tests {
    ...
    use fritillaria_csi::binning_index::Indexer;
    use fritillaria_sam::{
        self as sam,
        alignment::{
            RecordBuf,
