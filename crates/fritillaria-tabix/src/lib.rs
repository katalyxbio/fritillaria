//! **fritillaria-tabix** handles the reading and writing of the [tabix format].
//!
...
use fritillaria_csi::binning_index::{self, index::reference_sequence::index::LinearIndex};
