...
use fritillaria_csi::binning_index::index::reference_sequence::{Bin, Metadata};
...
where
    R: Read,
{
    use fritillaria_csi::io::reader::index::reference_sequences::{
        bins::read_chunks, read_metadata,
    };
