...
### Changed
  ...
  * tabix: Replace `Index` with `fritillaria_csi::Index`.

### Removed

  * tabix/index: Remove `Header`.

    Use `fritillaria_csi::index::Header` instead.
...
### Removed
  ...
  * tabix/index: Remove `ReferenceSequenceNames`.
    ...
    This was deprecated in fritillaria-tabix 0.11.0. Use
    `fritillaria_tabix::index::header::ReferenceSequenceNames` instead.
...
### Removed
  ...
  * tabix/index/reference_sequence: Removed `Metadata`.
    ...
    Use `fritillaria_csi::index::reference_sequence::Metadata` instead.
