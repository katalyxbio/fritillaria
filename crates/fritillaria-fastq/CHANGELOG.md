...
### Changed
  ...
  * fastq: Raise minimum supported Rust version (MSRV) to 1.89.0.

## 0.22.0 - 2026-02-18

### Changed

  * fastq: Raise minimum supported Rust version (MSRV) to 1.88.0.
...
### Removed
  ...
  * fastq: Remove `Record::name`.
    ...
    This was deprecated in fritillaria-fastq 0.2.0. Use `Record::name`
    instead.
