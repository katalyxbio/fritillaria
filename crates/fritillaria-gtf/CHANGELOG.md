...
### Changed
  ...
  * gtf: Raise minimum supported Rust version (MSRV) to 1.89.0.
...
### Changed
  ...
  * gtf: Raise minimum supported Rust version (MSRV) to 1.88.0.
...
### Fixed
  ...
  * gtf/record/attributes: Implement `AsRef<[Entry]>` ([#321]).
    ...
    This was missed in fritillaria-gtf 0.37.0.
