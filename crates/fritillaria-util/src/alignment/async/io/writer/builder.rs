...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_util::alignment::{r#async::io::writer::Builder, io::CompressionMethod};
    ...
    ///
    /// ```
    /// use fritillaria_util::alignment::{r#async::io::writer::Builder, io::Format};
    ...
    /// ```
    /// use fritillaria_fasta as fasta;
    /// use fritillaria_util::alignment::r#async::io::writer::Builder;
    ...
    /// use fritillaria_util::alignment::r#async::io::reader::Builder;
