...
use fritillaria_cram::{self as cram, container::BlockContentEncoderMap};
...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_util::alignment::{self, io::CompressionMethod};
    ...
    ///
    /// ```
    /// use fritillaria_util::alignment::{self, io::Format};
    /// let builder = alignment::io::writer::Builder::default()
    ...
    /// ```
    /// # use std::io;
    /// use fritillaria_cram::container::BlockContentEncoderMap;
    /// use fritillaria_util::alignment::{self, io::Format};
    ///
    /// let builder = alignment::io::writer::Builder::default()
