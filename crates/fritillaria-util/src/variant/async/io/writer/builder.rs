...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_util::variant::{r#async::io::writer::Builder, io::CompressionMethod};
    ...
    ///
    /// ```
    /// use fritillaria_util::variant::{r#async::io::writer::Builder, io::Format};
    ...
    /// use fritillaria_util::variant::r#async::io::writer::Builder;
