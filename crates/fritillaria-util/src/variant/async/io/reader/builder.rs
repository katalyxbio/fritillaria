...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_util::variant::{r#async::io::reader::Builder, io::CompressionMethod};
    ...
    ///
    /// ```
    /// use fritillaria_util::variant::{r#async::io::reader::Builder, io::Format};
    ...
    /// use fritillaria_util::variant::r#async::io::reader::Builder;
