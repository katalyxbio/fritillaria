...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_util::variant::io::{indexed_reader::Builder, CompressionMethod};
    ...
    ///
    /// ```
    /// use fritillaria_util::variant::io::{indexed_reader::Builder, Format};
    ...
    ///
    /// ```
    /// use fritillaria_csi as csi;
    /// use fritillaria_util::variant::io::indexed_reader::Builder;
    ///
