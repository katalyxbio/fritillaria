...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_util::variant::io::{writer::Builder, CompressionMethod};
    ...
    ///
    /// ```
    /// use fritillaria_util::variant::io::{writer::Builder, Format};
    ...
    /// ```no_run
    /// # use std::io;
    /// use fritillaria_util::variant::io::writer::Builder;
