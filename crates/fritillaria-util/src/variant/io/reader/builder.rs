...
impl Builder {
    ...
    ///
    /// ```
    /// use fritillaria_util::variant::io::{reader::Builder, CompressionMethod};
    ...
    ///
    /// ```
    /// use fritillaria_util::variant::io::{reader::Builder, Format};
    ...
    /// ```no_run
    /// # use std::io;
    /// use fritillaria_util::variant::io::reader::Builder;
