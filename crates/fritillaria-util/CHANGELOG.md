...
### Changed
  ...
  * util: Raise minimum supported Rust version (MSRV) to 1.89.0.
...
### Changed
  ...
  * util: Raise minimum supported Rust version (MSRV) to 1.88.0.
...
### Added
  ...
  * util/alignment: Add `iter` module from `fritillaria_sam::alignment`.
...
### Removed
  ...
  * util/variant: Remove `Compression`.
    ...
    This was deprecated in fritillaria-util 0.20.0 Use `CompressionMethod` instead.
